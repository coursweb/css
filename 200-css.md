...
Cette règle CSS a pour effet d'ajouter une icône (l'élément `\f214` qui correspond à un glyphe dans la fonte d'icônes [Genericons](https://genericons.com/)) devant chaque lien pointant vers [Tumblr](https://www.tumblr.com).

<style>

@font-face {
  font-family: "Genericons-Neue";
  src: url('http://cours-web.ch/fonts/Genericons-Neue.woff2') format('woff2');
}
